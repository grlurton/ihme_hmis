...
extract_dhis_datasets <- function(url , userID , password){
  ...
  try(extract_info(url , root , 'dataSets' , out , userID , password))
}
...
extract_data_elements <- function(dataset_url, userID, password){
  ...
  try(extract_info(dataset_url , root , 'dataElements' , out , userID , password))
}
...
extract_orgunits_list <- function(org_unit_page_url, userID, password){
  ...
  try(extract_info(org_unit_page_url , root , 'organisationUnits' , out , userID , password , TRUE))
}
...
extract_categories <- function(categories_url, userID, password){
  ...
  try(extract_info(categories_url , root , 'categoryOptionCombos' , out , userID , password))
}
