...
coverage_malaria <- make_coverage(data = data_fac , data_class = data_class , 
...
coverage_hiv <- make_coverage(data = data_fac , data_class = data_class , 
                                  data_x_org = data_elements_x_orgunit , 
                                  state_dico = state_dico , 
                                  theme = "indicator_thematic_HIV"  , 
                                  categories = 'malaria_sub' ,
                                  OrgUnitsHierarchy = OrgUnitsHierarchy)
...
pdf('hiv_plots.pdf' , width = 14)
plot_availability(coverage = coverage_hiv , 
                  categories = "indicator_thematic_HIV")
dev.off()
